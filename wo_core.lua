...
function wo_core_main(e)
 if MP_IsServer() == 1 then
 --
	--Text(-1,5,2,"You are the server")
	--Text(-1,10,2,"Game Mode " .. wo_core_gameMode )
  
  if wo_core_gameMode == 0 then
	wo_core_reset(e)
	wo_core_gameMode = 1
	SetMultiplayerGameMode(wo_core_gameMode)
  elseif wo_core_gameMode == 1 then
  ...
  elseif wo_core_gameMode == 2 then
